...
- New slogan in Settings: "fuck yeah, pixels".
- Updated Sparkle to 2.9.5, which hardens delta patching against a
  symlink attack.

### Fixed

- The yellow cover behind the Settings title bar now matches the window's
  real title-bar height, closing a see-through strip that could appear
  above the pinned preview.
...
[0.5.2]: https://github.com/JaimeOrtegaxyz/dab/compare/v0.5.1...v0.5.2
